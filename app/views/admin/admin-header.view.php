...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="<?= ROOT ?>">
            <?= APP_NAME ?> | Hi, <?= ucfirst(user('username')) ?>
        </a>
        ...
        <div id="navbarSearch2" class="navbar-search w-100 d-none d-md-block">
            <input class="form-control w-100 rounded-0 border-0" type="text" placeholder="Search"
                aria-label="Search">
        </div>
    </header>
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2"
                                    href="<?= ROOT ?>/admin/story">
                                    <span class="bi bi-clock-history"></span>
                                    <span class="pt-1">Story</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2"
                                    href="<?= ROOT ?>/admin/gallery">
                                    <span class="bi bi-images"></span>
                                    <span class="pt-1">Gallery</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2"
                                    href="<?= ROOT ?>/admin/family">
                                    <span class="bi bi-person-hearts"></span>
                                    <span class="pt-1">Family</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2"
                                    href="<?= ROOT ?>/admin/event">
                                    <span class="bi bi-calendar-event"></span>
                                    <span class="pt-1">Event</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2"
                                    href="<?= ROOT ?>/admin/rsvp">
                                    <span class="bi bi-envelope-heart"></span>
                                    <span class="pt-1">RSVP</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2"
                                    href="<?= ROOT ?>/admin/contact">
